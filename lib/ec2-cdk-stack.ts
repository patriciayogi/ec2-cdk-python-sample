  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
   ...
   // ************ Pipeline stuff ************
    ...
    const githubSourceAction = new GitHubSourceAction({
      ...
      oauthToken: SecretValue.secretsManager('github-oauth-token1'), // github secret
      owner: 'patriciayogi', // GITHUB USER NAME
      repo: 'sample-python-web-app',
      branch: 'main',
      output: sourceOutput,
    });

    console.log(githubSourceAction);
...
//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